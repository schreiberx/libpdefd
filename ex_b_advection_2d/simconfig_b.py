...
class SimConfig:
    ...
    def __init__(self, num_dims = 1):
        ...
        self.boundary_conditions_rho = ["periodic" for _ in range(self.num_dims)]
        self.boundary_conditions_vel = ["periodic" for _ in range(self.num_dims)]
