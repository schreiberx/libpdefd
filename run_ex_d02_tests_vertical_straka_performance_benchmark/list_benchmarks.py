...
for spatial_order in spatial_order_:
    for ns_type in ns_type_:
        ...
        for time_integration_method in ["leapfrog"]:

            for res_scaling_factor in [0.25, 0.5, 1, 2, 4, 8]:
                for dt_scaling_factor in [1]:
                    dt_scaling_factor = 1/res_scaling_factor

                    sim_time = dt_scaling_factor / (res_scaling_factor**2)
